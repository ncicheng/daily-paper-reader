...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-06 11:50:38 UTC<br>状态：成功</p>
</section>
...
<p>今日共筛选19篇论文，精读7篇、速读12篇，其中2篇精读获得满分。最值得关注的是LLM辅助无人机/ISR集群的安全保障与不确定性对抗方向，两篇满分论文分别提出反馈机制与运行时验证保障。建议普通读者优先从这两篇满分精读入手，理解AI自主系统的安全边界与验证思路。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Meeting Uncertain Threats with Feedback">Meeting Uncertain Threats with Feedback</span></li><li><span class="dpr-home-dashboard-paper-title" title="Mission-Level Runtime Assurance for LLM-Assisted ISR Swarms over a Verification-Aware Fabric">Mission-Level Runtime Assurance for LLM-Assisted ISR Swarms over a Verification-Aware Fabric</span></li><li><span class="dpr-home-dashboard-paper-title" title="Deep Reinforcement Learning: From First Principles to Reasoning Models">Deep Reinforcement Learning: From First Principles to Reasoning Models</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">military-ai <strong>5</strong></span><span class="dpr-home-dashboard-tag">ai-papers <strong>2</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Intelligent Multi-UAV Navigation in ITNTNs: A Hierarchical LLM Approach">Intelligent Multi-UAV Navigation in ITNTNs: A Hierarchical LLM Approach</span></li><li><span class="dpr-home-dashboard-paper-title" title="RepTran: Search-Based Repair of Transformer Models">RepTran: Search-Based Repair of Transformer Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="A Model for Mediating Multi-Modal Human Intent into Safe Maneuvers for UAVs">A Model for Mediating Multi-Modal Human Intent into Safe Maneuvers for UAVs</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">military-ai <strong>8</strong></span><span class="dpr-home-dashboard-tag">ai-papers <strong>4</strong></span></div>
</section>
</div>
